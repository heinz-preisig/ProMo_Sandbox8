...
\section*{Equation assignment sequence for variable ${p}{_{N}}$}
...
\hline
\endlastfoot
2 &V_15 &- &\begin{eq}{V}{_{N}} :: \text{port variable}\end{eq} & \\
1 &V_13 &- &\begin{eq}{U}{_{N}} :: \text{port variable}\end{eq} & \\
0 &V_17 &E_6 &\begin{eq}{p}{_{N}} := \left( -\ParDiff{{U}{_{N}}}{{V}{_{N}}} \right)\end{eq} & \\
