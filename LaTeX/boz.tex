...
\section*{Equation assignment sequence for variable ${boz}{_{N}}$}
...
\hline
\endlastfoot
2 &V_14 &- &\begin{eq}{S}{_{N}} :: \text{port variable}\end{eq} & \\
1 &V_1 &- &\begin{eq}{\#}{_{}} :: \text{port variable}\end{eq} & \\
0 &V_165 &E_132 &\begin{eq}{boz}{_{N}} := \text{Instantiate}({S}{_{N}}, {\#}{_{}})\end{eq} & \\
