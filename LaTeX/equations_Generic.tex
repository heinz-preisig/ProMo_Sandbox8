...
\endlastfoot
    ...
    \begin{eq}{\phi}{_{}} := \text{MixedStack}\left( {p}{_{N}},{T}{_{N}},{\mu}{_{{N S}}},{c_m}{_{{N S}}},{Ue}{_{N}} \right)\end{eq} &
    ...
    \begin{eq}{boz}{_{N}} := \text{Instantiate}({S}{_{N}}, {\#}{_{}})\end{eq} &
    \begin{lay}Boltzmann constant\end{lay} &
    \begin{lay}physical\end{lay} \\
        \hyperlink{"v:166"}{ 133 }\hypertarget{"e:133"}{  } &
    \begin{eq}{R}{_{N}} := {{A^v}}{_{}} \, . \, {boz}{_{N}}\end{eq} &
    \begin{lay}gas constant\end{lay} &
    \begin{lay}physical\end{lay} \\
    ...
    \begin{lay}macroscopic\end{lay} \\
        \hyperlink{"v:101"}{ 142 }\hypertarget{"e:142"}{  } &
    \begin{eq}{\dot{n}}{_{{N S}}} := {F}{_{{N S}, {A S}}} \stackrel{{A S}}{\,\star\,} \text{Stack}\left( {{\hat{n}^c}}{_{{A S}}},{\hat{n}^{c,controlled}}{_{{A S}}} \right)\end{eq} &
    \begin{lay}differential species balance switched\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
    ...
    \begin{eq}{c_m}{_{{N S}}} := \left( {V}{_{N}} \right)^{-1} \, {\odot} \, {n}{_{{N S}}}\end{eq} &
    ...
    \begin{eq}{c}{_{{A S}}} := \left({0.5}{_{}} \, . \, \left({F}{_{{N S}, {A S}}}  - {d}{_{A}} \, {\odot} \, |{F}{_{{N S}, {A S}}}|\right)\right) \stackrel{{N S}}{\,\star\,} {c_m}{_{{N S}}}\end{eq} &
    ...
    \begin{eq}{II}{_{N}} := \TotDiff{{C}{_{N}}}{{t}{_{}}}\end{eq} &
    ...
    \begin{eq}{Ue}{_{N}} := \left( {{R^e}}{_{N}} \right)^{-1} \, . \, {II}{_{N}}\end{eq} &
    \begin{lay}electrical potential -- voltage\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
