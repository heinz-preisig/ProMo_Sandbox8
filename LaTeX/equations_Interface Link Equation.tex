...
\hyperlink{"v:41"}{ 20 }\hypertarget{"e:20"}{  } &
    \begin{eq}{\mathring \lambda}{_{S}} := {\lambda}{_{S}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:58"}{ 37 }\hypertarget{"e:37"}{  } &
    \begin{eq}{\mathring m}{_{N}} := {m}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}macroscopic --> material\end{lay} \\
\hyperlink{"v:67"}{ 45 }\hypertarget{"e:45"}{  } &
    \begin{eq}{\mathring c}{_{{N S}}} := {c}{_{{N S}}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}macroscopic --> reactions\end{lay} \\
\hyperlink{"v:74"}{ 51 }\hypertarget{"e:51"}{  } &
    \begin{eq}{\mathring \rho}{_{N}} := {\rho}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:75"}{ 52 }\hypertarget{"e:52"}{  } &
    \begin{eq}{\mathring h}{_{{N S}}} := {h}{_{{N S}}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:76"}{ 53 }\hypertarget{"e:53"}{  } &
    \begin{eq}{{\mathring k^q_x}}{_{N}} := {{k^q_x}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:77"}{ 54 }\hypertarget{"e:54"}{  } &
    \begin{eq}{{\mathring C_v}}{_{N}} := {{C_V}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:78"}{ 55 }\hypertarget{"e:55"}{  } &
    \begin{eq}{{\mathring k^q_y}}{_{N}} := {{k^q_y}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:79"}{ 56 }\hypertarget{"e:56"}{  } &
    \begin{eq}{{\mathring k^q_z}}{_{N}} := {{k^q_z}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:80"}{ 57 }\hypertarget{"e:57"}{  } &
    \begin{eq}{{\mathring k^q}}{_{N}} := {{k^q}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:81"}{ 58 }\hypertarget{"e:58"}{  } &
    \begin{eq}{{\mathring k^c_x}}{_{N}} := {{k^c_x}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:82"}{ 59 }\hypertarget{"e:59"}{  } &
    \begin{eq}{{\mathring C_p}}{_{N}} := {{C_p}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:83"}{ 60 }\hypertarget{"e:60"}{  } &
    \begin{eq}{{\mathring k^c_y}}{_{N}} := {{k^c_y}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:84"}{ 61 }\hypertarget{"e:61"}{  } &
    \begin{eq}{{\mathring k^c_z}}{_{N}} := {{k^c_z}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:85"}{ 62 }\hypertarget{"e:62"}{  } &
    \begin{eq}{{\mathring k^c}}{_{N}} := {{k^c}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:86"}{ 63 }\hypertarget{"e:63"}{  } &
    \begin{eq}{{\mathring k^d_x}}{_{{N S}}} := {{k^d_x}}{_{{N S}}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:87"}{ 64 }\hypertarget{"e:64"}{  } &
    \begin{eq}{{\mathring k^d_y}}{_{{N S}}} := {{k^d_y}}{_{{N S}}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:88"}{ 65 }\hypertarget{"e:65"}{  } &
    \begin{eq}{{\mathring k^d_z}}{_{{N S}}} := {{k^d_z}}{_{{N S}}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:89"}{ 66 }\hypertarget{"e:66"}{  } &
    \begin{eq}{{\mathring k^d}}{_{{N S}}} := {{k^d}}{_{{N S}}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
\hyperlink{"v:114"}{ 90 }\hypertarget{"e:90"}{  } &
    \begin{eq}{\mathring I}{_{N}} := {I}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}macroscopic --> material\end{lay} \\
\hyperlink{"v:117"}{ 94 }\hypertarget{"e:94"}{  } &
    \begin{eq}{{\mathring R^e}}{_{N}} := {{k^{e,\xi}}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}material --> macroscopic\end{lay} \\
...
\hyperlink{"v:142"}{ 114 }\hypertarget{"e:114"}{  } &
    \begin{eq}{\mathring Ue}{_{N}} := {Ue}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}macroscopic --> control\end{lay} \\
\hyperlink{"v:164"}{ 131 }\hypertarget{"e:131"}{  } &
    \begin{eq}{\mathring {\tilde{n}}}{_{{N S}}} := {\tilde{n}}{_{{N S}}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
